...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_GREY = SET_TEXT_COLOR + "253m";
    public static final String SET_TEXT_COLOR_DARK_GREY = SET_TEXT_COLOR + "235m";
    public static final String SET_TEXT_COLOR_RED = SET_TEXT_COLOR + "183m";
    ...
    public static final String SET_TEXT_COLOR_BLUE = SET_TEXT_COLOR + "39m";
    ...
    public static final String SET_BG_COLOR_RED = SET_BG_COLOR + "183m";
    public static final String SET_BG_COLOR_DARK_RED = SET_BG_COLOR + "177m";
    public static final String SET_BG_COLOR_DARK_DARK_RED = SET_BG_COLOR + "171m";
