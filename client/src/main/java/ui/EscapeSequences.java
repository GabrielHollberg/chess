...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_RED = SET_TEXT_COLOR + "1m";
    ...
    public static final String SET_TEXT_COLOR_BLUE = SET_TEXT_COLOR + "27m";
    ...
    public static final String SET_BG_COLOR_BLUE = SET_BG_COLOR + "21m";
