...
public class ClientGame {
    ...
    public void run() {
        ...
        System.out.println(EMPTY + "  ------------Chess------------      " + SET_TEXT_COLOR_BLUE + "(You can always type "
                + SET_TEXT_COLOR_RED + "\"h\"" + SET_TEXT_COLOR_BLUE + " for a list of commands)\n" + SET_TEXT_COLOR_BLUE);
        command = scanner.nextLine();
        while (true) {
            while (true) {
                if (command.equalsIgnoreCase("help") || command.equalsIgnoreCase("h")) {
                    System.out.println("\n" + EMPTY + "  ------------Chess------------      " + SET_TEXT_COLOR_RED
                            + "\"h\" " + SET_TEXT_COLOR_BLUE + "(help)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED + "\"r\" "
                            + SET_TEXT_COLOR_BLUE + "(register)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED + "\"l\" "
                            + SET_TEXT_COLOR_BLUE + "(login)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED + "\"q\" "
            ...
            System.out.println(SET_TEXT_COLOR_BLUE + SET_BG_COLOR_BLACK);
            System.out.println(EMPTY + "  ------------Chess------------      " + SET_TEXT_COLOR_BLUE + "Signed in as "
                    + SET_TEXT_COLOR_RED + username + SET_TEXT_COLOR_BLUE + "! (type " + SET_TEXT_COLOR_RED + "\"h\""
                    + SET_TEXT_COLOR_BLUE + " for more commands)\n" + SET_TEXT_COLOR_BLUE);
            command = scanner.nextLine();
            while (true) {
                if (command.equalsIgnoreCase("help") || command.equalsIgnoreCase("h")) {
                    System.out.println("\n" + EMPTY + "  ------------Chess------------      " + SET_TEXT_COLOR_RED
                            + "\"h\" " + SET_TEXT_COLOR_BLUE + " (help)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED
                            + "\"c\" " + SET_TEXT_COLOR_BLUE + " (create a new game)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED
                            + "\"v\" " + SET_TEXT_COLOR_BLUE + " (view games)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED
                            + "\"j\" " + SET_TEXT_COLOR_BLUE + " (join a game)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED
                            + "\"s\" " + SET_TEXT_COLOR_BLUE + " (spectate a game)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED
                            + "\"l\" " + SET_TEXT_COLOR_BLUE + " (logout)");
                    System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED
                            + "\"q\" " + SET_TEXT_COLOR_BLUE + " (quit)\n" + SET_TEXT_COLOR_BLUE);
                    command = scanner.nextLine();
                    ...
                    try {
                        ...
                        System.out.println("\n" + EMPTY + "  ------------Chess------------      Game "
                                + SET_TEXT_COLOR_RED + gameName + SET_TEXT_COLOR_BLUE + " created! (type "
                                + SET_TEXT_COLOR_RED + "\"join\"" + SET_TEXT_COLOR_BLUE + " or " + SET_TEXT_COLOR_RED
                                + "\"j\"" + SET_TEXT_COLOR_BLUE + " and use game number " + SET_TEXT_COLOR_RED
                                + createGameResult.gameID() + SET_TEXT_COLOR_BLUE + " if you would like to join this game)\n");
                        command = scanner.nextLine();
                    } catch (Exception e) {
                        System.out.println("\n" + EMPTY + "  ------------Chess------------      "
                                + SET_TEXT_COLOR_RED + "Sorry, This game could not be created!\n" + SET_TEXT_COLOR_BLUE);
                        command = scanner.nextLine();
                    }
                    ...
                    try {
                        ...
                        if (listGamesResult.games().isEmpty()) {
                            ...
                            System.out.println("If you'd like to join a game, remember the " + SET_TEXT_COLOR_RED
                                    + "game #" + SET_TEXT_COLOR_BLUE + " and type " + SET_TEXT_COLOR_RED + "\"j\"" + SET_TEXT_COLOR_BLUE);
                            System.out.println(EMPTY + "                                     " +
                                    "(You may not take a slot that has already been filled)\n");
                            for (int i = 0; i < listGamesResult.games().size(); i++) {
                                System.out.print(EMPTY + "                                     "
                                        + SET_TEXT_COLOR_RED + (i + 1) + ". " + SET_TEXT_COLOR_BLUE
                                        + listGamesResult.games().get(i).gameName());
                                if (listGamesResult.games().get(i).whiteUsername() != null) {
                                    System.out.print("\n" + EMPTY + "                                     "
                                            + "white: " + SET_TEXT_COLOR_BLUE + listGamesResult.games().get(i).whiteUsername());
                                } else {
                                    System.out.print("\n" + EMPTY + "                                     "
                                            + "white: ");
                                }
                                if (listGamesResult.games().get(i).blackUsername() != null) {
                                    System.out.print("\n" + EMPTY + "                                     "
                                            + "black: " + SET_TEXT_COLOR_BLUE + listGamesResult.games().get(i).blackUsername());
                                } else {
                                    System.out.print("\n" + EMPTY + "                                     "
                                            + "black: " + SET_TEXT_COLOR_BLUE);
                                }
                                System.out.println();
                                System.out.println();
                            }
                            System.out.println(EMPTY + "                                     "
                                    + "If you'd like to join a game, remember the " + SET_TEXT_COLOR_RED
                                    + "game #" + SET_TEXT_COLOR_BLUE + " and type " + SET_TEXT_COLOR_RED
                                    + "\"j\"" + SET_TEXT_COLOR_BLUE);
                            System.out.println(EMPTY + "                                     " +
                                    "(You may not take a slot that has already been filled)");
                        }
                        System.out.println();
                        ...
                        System.out.println("\n" + EMPTY + "  ------------Chess------------      " + SET_TEXT_COLOR_RED
                                + "Sorry, the games could not be viewed!\n" + SET_TEXT_COLOR_BLUE);
                        command = scanner.nextLine();
                    }
                } else if (command.equalsIgnoreCase("join") || command.equalsIgnoreCase("j")) {
                    try {
                        System.out.println("\n" + EMPTY + "  (if you don't know your " + SET_TEXT_COLOR_RED + "game # "
                                + SET_TEXT_COLOR_BLUE + "type " + SET_TEXT_COLOR_RED + "\"v\"" + SET_TEXT_COLOR_BLUE + ")");
                        System.out.println("\n" + EMPTY + "  game number:\n");
                        if (scanner.hasNextInt()) {
                            ...
                            if (playerColor.equalsIgnoreCase("white") || playerColor.equalsIgnoreCase("w")) {
                                ...
                                System.out.println("\n" + EMPTY + "  ------------Chess------------      Playing game " + SET_TEXT_COLOR_RED
                                        + gameNumber + SET_TEXT_COLOR_BLUE + " as " + SET_TEXT_COLOR_RED + "white" + SET_TEXT_COLOR_BLUE
                                        + " (type " + SET_TEXT_COLOR_RED + "\"h\"" + SET_TEXT_COLOR_BLUE + " for more commands)"
                                        + SET_TEXT_COLOR_BLUE);
                                    ...
                                    if (chessGame.getGameOver()) {
                                        while (true) {
                                            if (command.equalsIgnoreCase("refresh") || command.equalsIgnoreCase("r")) {
                                                ...
                                                System.out.println("\n" + EMPTY + "  ------------Chess------------      "
                                                        + SET_TEXT_COLOR_RED + "\"h\" " + SET_TEXT_COLOR_BLUE + " (help)");
                                                System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED
                                                        + "\"r\" " + SET_TEXT_COLOR_BLUE + " (refresh board)" + SET_TEXT_COLOR_BLUE);
                                                System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED
                                                        + "\"l\" " + SET_TEXT_COLOR_BLUE + " (leave game)\n" + SET_TEXT_COLOR_BLUE);
                                                command = scanner.nextLine();
                                                ...
                                                System.out.println("\n" + EMPTY + "  ------------Chess------------      "
                                                        + SET_TEXT_COLOR_RED + "Invalid command!\n" + SET_TEXT_COLOR_BLUE);
                                                command = scanner.nextLine();
                                            }
                                        }
                                        break;
                                        ...
                                        System.out.println("\n" + EMPTY + "  ------------Chess------------      Playing game "
                                                + SET_TEXT_COLOR_RED + gameNumber + SET_TEXT_COLOR_BLUE + " as "
                                                + SET_TEXT_COLOR_RED + "white" + SET_TEXT_COLOR_BLUE + " (type "
                                                + SET_TEXT_COLOR_RED + "\"h\"" + SET_TEXT_COLOR_BLUE + " for more commands)"
                                                + SET_TEXT_COLOR_BLUE);
                                        printBoard(chessGame.getBoard());
                                        command = scanner.nextLine();
                                        ...
                                        if (moveCoordinates.length() == 4 && (moveCoordinates.charAt(0) == 'a'
                                                || moveCoordinates.charAt(0) == 'b'
                                                || moveCoordinates.charAt(0) == 'c' || moveCoordinates.charAt(0) == 'd'
                                                || moveCoordinates.charAt(0) == 'e'
                                                || moveCoordinates.charAt(0) == 'f' || moveCoordinates.charAt(0) == 'g'
                                                || moveCoordinates.charAt(0) == 'h'
                                                || moveCoordinates.charAt(0) == 'A' || moveCoordinates.charAt(0) == 'B'
                                                || moveCoordinates.charAt(0) == 'C'
                                                || moveCoordinates.charAt(0) == 'D' || moveCoordinates.charAt(0) == 'E'
                                                || moveCoordinates.charAt(0) == 'F'
                                                || moveCoordinates.charAt(0) == 'G' || moveCoordinates.charAt(0) == 'H')
                                                && (moveCoordinates.charAt(1) == '1'
                                                || moveCoordinates.charAt(1) == '2' || moveCoordinates.charAt(1) == '3'
                                                || moveCoordinates.charAt(1) == '4'
                                                || moveCoordinates.charAt(1) == '5' || moveCoordinates.charAt(1) == '6'
                                                || moveCoordinates.charAt(1) == '7'
                                                || moveCoordinates.charAt(1) == '8') && (moveCoordinates.charAt(2) == 'a'
                                                || moveCoordinates.charAt(2) == 'b'
                                                || moveCoordinates.charAt(2) == 'c' || moveCoordinates.charAt(2) == 'd'
                                                || moveCoordinates.charAt(2) == 'e'
                                                || moveCoordinates.charAt(2) == 'f' || moveCoordinates.charAt(2) == 'g'
                                                || moveCoordinates.charAt(2) == 'h'
                                                || moveCoordinates.charAt(2) == 'A' || moveCoordinates.charAt(2) == 'B'
                                                || moveCoordinates.charAt(2) == 'C'
                                                || moveCoordinates.charAt(2) == 'D' || moveCoordinates.charAt(2) == 'E'
                                                || moveCoordinates.charAt(2) == 'F'
                                                || moveCoordinates.charAt(2) == 'G' || moveCoordinates.charAt(2) == 'H')
                                                && (moveCoordinates.charAt(3) == '1'
                                                || moveCoordinates.charAt(3) == '2' || moveCoordinates.charAt(3) == '3'
                                                || moveCoordinates.charAt(3) == '4'
                                                || moveCoordinates.charAt(3) == '5' || moveCoordinates.charAt(3) == '6'
                                                || moveCoordinates.charAt(3) == '7'
                                            ...
                                            if (chessGame.getBoard().getPiece(startPosition) != null) {
                                                ...
                                                System.out.println("\n" + EMPTY + "  ------------Chess------------      Playing game "
                                                        + SET_TEXT_COLOR_RED + gameNumber + SET_TEXT_COLOR_BLUE + " as " + SET_TEXT_COLOR_RED
                                                        + "white" + SET_TEXT_COLOR_BLUE + " (type " + SET_TEXT_COLOR_RED + "\"h\""
                                                        + SET_TEXT_COLOR_BLUE + " for more commands)" + SET_TEXT_COLOR_BLUE);
                                        ...
                                        System.out.println("\n" + EMPTY + "  ------------Chess------------      " + SET_TEXT_COLOR_RED
                                                + "\"h\" " + SET_TEXT_COLOR_BLUE + " (help)");
                                        System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED + "\"v\" "
                                                + SET_TEXT_COLOR_BLUE + " (view moves)" + SET_TEXT_COLOR_BLUE);
                                        System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED + "\"m\" "
                                                + SET_TEXT_COLOR_BLUE + " (move piece)" + SET_TEXT_COLOR_BLUE);
                                        System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED + "\"r\" "
                                                + SET_TEXT_COLOR_BLUE + " (refresh board)" + SET_TEXT_COLOR_BLUE);
                                        System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED + "\"f\" "
                                                + SET_TEXT_COLOR_BLUE + " (forfeit)" + SET_TEXT_COLOR_BLUE);
                                        System.out.println(EMPTY + "                                     " + SET_TEXT_COLOR_RED + "\"l\" "
                                                + SET_TEXT_COLOR_BLUE + " (leave game)\n" + SET_TEXT_COLOR_BLUE);
                                        command = scanner.nextLine();
                                    } else if (command.equalsIgnoreCase("view") || command.equalsIgnoreCase("v")) {
                                        System.out.println("\n" + EMPTY + "  piece coordinates (a8, b4, etc.):\n");
                                        String startSquare = scanner.nextLine();
                                        if (!(startSquare.length() != 2 || (startSquare.charAt(0) != 'a' && startSquare.charAt(0) != 'b'
                                                && startSquare.charAt(0) != 'c' && startSquare.charAt(0) != 'd' && startSquare.charAt(0) != 'e'
                                                && startSquare.charAt(0) != 'f' && startSquare.charAt(0) != 'g' && startSquare.charAt(0) != 'h'
                                                && startSquare.charAt(0) != 'A' && startSquare.charAt(0) != 'B' && startSquare.charAt(0) != 'C'
                                                && startSquare.charAt(0) != 'D' && startSquare.charAt(0) != 'E' && startSquare.charAt(0) != 'F'
                                                && startSquare.charAt(0) != 'G' && startSquare.charAt(0) != 'H') || (startSquare.charAt(1) != '1'
                                                && startSquare.charAt(1) != '2' && startSquare.charAt(1) != '3' && startSquare.charAt(1) != '4'
                                                && startSquare.charAt(1) != '5' && startSquare.charAt(1) != '6' && startSquare.charAt(1) != '7'
                                                && startSquare.charAt(1) != '8'))) {
                                            int i = 0;
                                            int j = 0;
                                ...
                                serverFacade.joinGame(joinGameRequest);
                                System.out.println("\n" + EMPTY + "  ------------Chess------------      Playing game " + SET_TEXT_COLOR_RED
                                        + gameNumber + SET_TEXT_COLOR_BLUE + " as " + SET_TEXT_COLOR_RED + "black" + SET_TEXT_COLOR_BLUE
                                        + " (type " + SET_TEXT_COLOR_RED + "\"h\"" + SET_TEXT_COLOR_BLUE + " for more commands)"
                                        + SET_TEXT_COLOR_BLUE);
                                serverFacade.createWSConnection(this, gameNumber);
                                command = scanner.nextLine();
                                while (true) {
                                    if (chessGame.getGameOver()) {
                                        ...
                                        System.out.println("\n" + EMPTY + "  ------------Chess------------      Playing game "
                                                + SET_TEXT_COLOR_RED + gameNumber + SET_TEXT_COLOR_BLUE + " as " + SET_TEXT_COLOR_RED
                                                + "black" + SET_TEXT_COLOR_BLUE + " (type " + SET_TEXT_COLOR_RED + "\"h\""
                                                + SET_TEXT_COLOR_BLUE + " for more commands)" + SET_TEXT_COLOR_BLUE);
                                        ...
                                        System.out.println("\n" + EMPTY + "Type \"f\" again to confirm forfeit:\n");
                                        command = scanner.nextLine();
                                        if (command.equalsIgnoreCase("forfeit")
                                                || command.equalsIgnoreCase("f")) {
                                            serverFacade.forfeitGame(gameNumber);
                                            command = "refresh";
                                            while (true) {
                                                if (command.equalsIgnoreCase("refresh")
                                                    ...
                                                    System.out.println("\n" + EMPTY + "  ------------Chess------------      "
                                                            + SET_TEXT_COLOR_RED + "\"h\" " + SET_TEXT_COLOR_BLUE + " (help)");
                                                    System.out.println(EMPTY + "                                     "
                                                            + SET_TEXT_COLOR_RED + "\"r\" " + SET_TEXT_COLOR_BLUE
                                                            + " (refresh board)" + SET_TEXT_COLOR_BLUE);
                                                    System.out.println(EMPTY + "                                     "
                                                            + SET_TEXT_COLOR_RED + "\"l\" " + SET_TEXT_COLOR_BLUE
                                                            + " (leave game)\n" + SET_TEXT_COLOR_BLUE);
                                                    command = scanner.nextLine();
                    ...
                    try {
                        ...
                        System.out.println("\n" + EMPTY + "  ------------Chess------------      Spectating game " + SET_TEXT_COLOR_RED +
                                gameNumber + SET_TEXT_COLOR_BLUE + " (type " + SET_TEXT_COLOR_RED + "\"h\"" + SET_TEXT_COLOR_BLUE
                                + " for more commands)" + SET_TEXT_COLOR_BLUE);
                        serverFacade.createWSConnection(this, gameNumber);
                        command = scanner.nextLine();
                        while (true) {
                            if (command.equalsIgnoreCase("refresh") || command.equalsIgnoreCase("r")) {
                                ...
                                System.out.println("\n" + EMPTY + "  ------------Chess------------      " + SET_TEXT_COLOR_RED + "\"h\" "
    ...
    public void onMessage(String message) {
        ...
        if (serverMessage.getServerMessageType() == ServerMessage.ServerMessageType.LOAD_GAME) {
            ...
            System.out.println("\n" + EMPTY + "  ------------Chess------------      " + serverMessage.errorMessage + "\n");
            if (playerColor.equals("black") || playerColor.equals("b")) {
                printBoardFlipped(chessGame.getBoard());
            } else if (playerColor.equals("white") || playerColor.equals("w")) {
                printBoard(chessGame.getBoard());
